...
public class Guess_the_number {
    ...
    public Guess_the_number() {
        ...
        jframe.getContentPane().setBackground(new Color(0xadd8e6));
        img = new ImageIcon("C:\\Users\\ABHISHEK JHA\\Desktop\\SkillCraft Technology Internship\\Guess.png");
        ...
        submit.addActionListener(e -> {
            ...
            label.setText("<html>Hi " + input.getText()
                    + ",<p style=\"font-size: medium;font-family: 'Times New Roman', Times, serif\"> Let's play a game called guessing the number.<br/>I have chosen a random number lying between 0 to 100<br/>Can you guess what it is? 🤔🤔</p></html>");
            input.setText("");
